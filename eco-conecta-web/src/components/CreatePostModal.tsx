...
import { createPost } from "@/controllers/apiContentController";
type Props = {
  isOpen: boolean;
  onClose: () => void;
};
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 border text-black rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-colors"
              />
              <button
                type="button"
                onClick={addTag}
                className="px-3 py-2 border border-green-200 text-green-600 hover:bg-green-50 rounded-lg transition-colors"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
            ...
            {formData.tags && formData.tags.length > 0 && (
              <div className="flex flex-wrap gap-2">
                {formData.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="inline-flex items-center gap-1 px-3 py-1 bg-green-100 text-black  rounded-full text-sm"
                  >
                    {tag}
                    <button
                      type="button"
